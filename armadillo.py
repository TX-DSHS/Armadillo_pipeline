...
results["Organism_ID"] = results["mash_genus"] + " " + results["mash_species"]
results = pd.merge(results, ncbi_genome_size, on = "Organism_ID", how = "left")
...
#column = ["sample_id", "sample", "Organism_ID", "Status", "QCtag", "cg_coverage", "quast_contigs", "quast_length", "quast_gc_%", "ncbi_median_genome_size", "ncbi_GC_%", "blaKPC", "blaNDM", "blaOXA-48", "blaVIM", "blaIMP", "blaOXA-23", "blaOXA-24/40", "blaOXA-58"]
column = ["sample_id", "sample", "Organism_ID", "kraken2_top_species", "Status", "QCtag", "cg_coverage", "quast_contigs", "quast_length", "quast_gc_%", "blaKPC", "blaNDM", "blaOXA-48", "blaVIM", "blaIMP", "blaOXA-23", "blaOXA-24/40", "blaOXA-58"]
...
passSample_species = list(results[results["Status"] == "Complete"]["mash_species"])
passSample_genus = list(results[results["Status"] == "Complete"]["mash_genus"])
...
footnote = ("\n").join(footnote)
for s, id, genus, species in zip(passSamples, passSample_Ids, passSample_genus, passSample_species):
    #print (s, id)
