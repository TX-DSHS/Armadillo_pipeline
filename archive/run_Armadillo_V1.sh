...
nextflow run $basedir/grandeur_mlst.nf -profile singularity -c $basedir/AMR.config --reads $basedir/reads/$1 --outdir $basedir/results/$1
#rm -r $basedir/results/$1/work
rm -r $basedir/results/$1/shuffled
rm $basedir/results/zip/$1.zip
# Run Armadillo pipeline
python3 $basedir/armadillo.py -r $1
