...
aws s3 cp $basedir/results/zip/$1_report.zip s3://430118851772-bioinformatics-infectious-disease/ARLN/REPORT/$1_report.zip
zip -r $basedir/results/zip/$1_result $basedir/results/$1
aws s3 cp $basedir/results/zip/$1_result.zip s3://430118851772-bioinformatics-infectious-disease/ARLN/ANALYSIS_RESULTS/$1_result.zip
